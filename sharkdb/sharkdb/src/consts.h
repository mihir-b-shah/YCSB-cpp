...
static constexpr size_t MEM_TABLE_MAX_ENTRIES = 500000; // per partition
static constexpr size_t LOG_BUF_FLUSH_INTV = 100000; // per partition- TODO change
static constexpr size_t LOG_BUF_MAX_ENTRIES = 800000; // per partition- TODO change

...
static constexpr size_t MEM_TABLE_MAX_ENTRIES = 15000; // per partition
static constexpr size_t LOG_BUF_FLUSH_INTV = 5000; // per partition- TODO change
static constexpr size_t LOG_BUF_MAX_ENTRIES = 40000; // per partition- TODO change
